...
public record PlaceGroupBlockResponse(
	...
	public static PlaceGroupBlockResponse of(Long placeBlockId, List<Long> placeGroupIds) {
		return new PlaceGroupBlockResponse(List.of(placeBlockId), placeGroupIds);
	}

	public static PlaceGroupBlockResponse of(List<Long> placeBlockIds, Long placeGroupId) {
		return new PlaceGroupBlockResponse(placeBlockIds, List.of(placeGroupId));
	}
}
